...
public class UserIDSendMail extends Thread {
	...
	public boolean addUserMail(String address, String username, String nickname, String user_id) {
		...
		this.message = "<br>★ユーザIDのご確認のお知らせ★<br><br><div>いつも「CLIP」をご利用いただき、誠にありがとうございます。<br><br>" +
				"ユーザIDを送信しましたので、ご確認ください。<br><br><br>ユーザネーム:" +
				username + "<br>ニックネーム:" + nickname + "<br>ユーザID:" + user_id +
