	...
	var setappend = function(json) {
		...
		for ( var i = 0; i < json.length; i++) {
			...
			// リクエスト申請したユーザ一覧
				...
				// フレンドの場合
				$('#table-body').append('<tr class="first"><td><h8 id="friend"' + json[i].friend_user_id + '">' + "<a class='art-title' href='index.html'onclick='" +
						"javascript:setSessionStorage(\"friend\",\""+json[i].nickname+"\");setSessionStorage(\"viewMode\",\"3\");setSessionStorage(\"shareLists\",\""+
